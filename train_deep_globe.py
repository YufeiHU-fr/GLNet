...
dataset_train = DeepGlobe(os.path.join(data_path, "train"), label=True, transform=True)
...
dataset_val = DeepGlobe(os.path.join(data_path, "crossvali"), label=True)
...
dataset_test = DeepGlobe(os.path.join(data_path, "offical_crossvali"), label=False)
